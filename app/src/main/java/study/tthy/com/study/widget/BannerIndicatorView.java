...
import study.tthy.com.study.util.LogUtil;
...
public class BannerIndicatorView extends View {
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        indicatorStyle = t.getInt(R.styleable.BannerIndicatorView_app_indicator_style, INDICATOR_STYLE_RECT);

        cellRadius = t.getDimensionPixelOffset(R.styleable.BannerIndicatorView_app_cell_radius, 25);
        cellMarginSize = t.getDimensionPixelOffset(R.styleable.BannerIndicatorView_app_cell_margin, 0);
