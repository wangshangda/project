package study.tthy.com.study.widget.head;
...
public class DefaultHead extends ViewGroup implements RefreshHeader {
    ...
    public DefaultHead(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mProgress.setColorSchemeColors(getResources().getColor(R.color.colorToolBar));
...
//                resolveSize(getSuggestedMinimumHeight(), heightMeasureSpec));
     ...
     */
    public DefaultHead setColorSchemeColors(int... colors) {
     ...
     * @return MaterialHeader
     */
    public DefaultHead setSize(int size) {
     ...
     * @return MaterialHeader
     */
    public DefaultHead setShowBezierWave(boolean show) {
